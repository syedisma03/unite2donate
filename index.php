...
<form method="GET" action="http://localhost/techc/index.php/">
<div id="main"><div id="box">
<button id="h">LOGIN</button><br>
...
<p id="dash">- - - - - - - - - - - - - - - - - - - - - - - - - -</p>
<p id="reg"><a href="http://localhost/techc/forms.php/">Register</a></p>
...
$link=mysqli_connect('localhost','root','','blooddonors');
	if(isset($_GET['subm']))
	{
		...
		{
			echo "login";
                  header("location:http://localhost/techc/login.php/");
		}
		else  
			echo '<script>alert("Enter Valid Login id & Password")</script>';	
	}
            else
                  echo "no";
